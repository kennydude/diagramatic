...
namespace Geometry{
	public class Dimension{
		 ...
		 */
		public static Dimension SINGLETON = new Dimension();
		 ...
		 * @since 2.0
		 */
		public static Dimension from_integers(int w, int h) {
		 ...
		 * @since 3.8
		 */
		public Dimension expand_by_double(double w, double h) {
			return expand_by_int((int) w, (int) h);
		}
		 ...
		 * @since 2.0
		 */
		public Dimension expand_by_int(int w, int h) {
			width += w;
			height += h;
			return this;
		}
		 ...
		 * @since 2.0
		 */
		public Dimension getExpanded_by_dimesion(Dimension d) {
			return getCopy().expand_by_dimension(d);
		}
		 ...
		 * @since 3.8
		 */
		public Dimension getExpanded_by_double(double w, double h) {
			return getCopy().expand_by_double(w, h);
		}
		 ...
		 * @since 2.0
		 */
		public Dimension getExpanded_by_int(int w, int h) {
			return getCopy().expand_by_int(w, h);
		}
		...
		public Dimension getShrinked(Dimension d) {
			return getCopy().shrink_by_dimension(d);
		}
		 ...
		 * @since 3.7
		 */
		public Dimension getShrinked_by_int(int w, int h) {
			return getCopy().shrink_by_int(w, h);
		}
		 ...
		 * @since 2.0
		 */
		public Dimension scale_factor(double factor) {
			return scale_factors(factor, factor);
		}
		 ...
		 * @since 2.0
		 */
		public Dimension scale_factors(double widthFactor, double heightFactor) {
		 ...
		 * @since 3.7
		 */
		public Dimension setSize_by_int(int w, int h) {
			width = w;
			height = h;
			return this;
		}
		 ...
		 * @since 3.8
		 */
		public Dimension shrink_by_double(double w, double h) {
			return shrink_by_int((int) w, (int) h);
		}
		 ...
		 * @since 2.0
		 */
		public Dimension shrink_by_int(int w, int h) {
			width -= w;
			height -= h;
			return this;
		}
